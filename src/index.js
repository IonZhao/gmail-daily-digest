...
3. 邮件分类规则（务必严格区分以下两类）：
   ...
   📬 已提交申请的状态更新：
   - 来自你已经申请过的公司的回复邮件
   - 包含：确认收到申请、正在审核、面试邀请、拒信等
   - 例如："Application received", "Interview invitation", "Thank you for applying"
   - 这些是你需要跟踪的申请进展

   💼 新职位推荐/通知：
   - 来自招聘平台（LinkedIn、ZipRecruiter等）的新职位推荐
   - 来自公司的招聘广告邮件
   - 你还未申请的职位通知
   - 这些是潜在的新机会
...
1. [公司名称] - [职位名称]
   ⚠️ 状态：[申请已收到/正在审核/面试邀请/已拒绝等]
   📝 重要行动：[如果需要采取行动，如填写表格、准备面试等]
   💡 提示：[如果有重要信息，如验证码、截止时间等]
...
请仔细分析这些邮件，严格区分"已申请职位的状态更新"和"新职位推荐"这两类邮件，提取关键信息，生成一份清晰、易读的中文摘要。
记住：使用纯文本格式和 Unicode 字符，不要使用 Markdown。`;
